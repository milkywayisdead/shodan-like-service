...
urlpatterns = [
    ...
    path('search/city', sv.CitySearch.as_view(), name='search_city'),
    path('search/country', sv.CountrySearch.as_view(), name='search_country'),
    ...
    path('search/country/page', sv.CountryPage.as_view(), name='country_page'),
    path('search/city/page', sv.CityPage.as_view(), name='city_page'),
