...
RATELIMIT_USER_LIMIT = int(os.environ.get('RATELIMIT_USER_LIMIT', 10))
RATELIMIT_IP_LIMIT = int(os.environ.get('RATELIMIT_IP_LIMIT', 10))
RATELIMIT_USER_INTERVAL = int(os.environ.get('RATELIMIT_USER_INTERVAL', 300))
RATELIMIT_IP_INTERVAL = int(os.environ.get('RATELIMIT_IP_INTERVAL', 300))
